...
/**
 * si no inicias session y entras atraves de url te saldra alerta . 
 * cambio de session donde esta obligatorio iniciar session para cambiar la contraseña . 
 */
if (isset($_SESSION['token']) && isset($_SESSION['validaciontoken'])) {
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <?php Cambiocontraseñaerrores() ?>
                            </div>

                            <button type="submit" name="cambiocontraseña" class="btn" style="background-color: rgba(117, 149, 252, 255); color: white;">Cambiar Contraseña</button>
                        </form>
                    </div>
